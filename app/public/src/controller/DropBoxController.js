class DropBoxController {
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyBzzIQdtBOuZfoMht2LWVx9ODbuXaoPQcM",
            authDomain: "dropbox-clone-9a9a7.firebaseapp.com",
            databaseURL: "https://dropbox-clone-9a9a7.firebaseio.com",
            projectId: "dropbox-clone-9a9a7",
            storageBucket: "dropbox-clone-9a9a7.appspot.com",
            messagingSenderId: "687422673715",
            appId: "1:687422673715:web:3e98e28d4c2a3301442446",
            measurementId: "G-X7178FMDX9"
        };
        ...
        return new Promise((resolve, reject) => {
            ...
            folderRef.on('value', snapshot => {
                ...
                if (snapshot.exists()) {
                    ...
                    this.getFirebaseRef('Trainee').child(key).remove();
    ...
    removeTask() {
        ...
        this.getSelection().forEach(li => {
            ...
            /* -- Removendo arquivo do localStorage
    ...
    initEvents() {
        ...
        this.listFileEl.addEventListener('selectionchange', event => {
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.btnSendFileEl.bisabled = true;
    ...
    uploadComplete() {
        ...
        this.btnSendFileEl.bisabled = false;
